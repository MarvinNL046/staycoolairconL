...
export const handler = async (event, context) => {
  ...
  try {
    const { name, email, phone, city, message, subject } = JSON.parse(event.body);
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="field">
            ...
            <div class="message-box">${message || 'Geen extra bericht.'}</div>
          </div>
        </div>
        <div class="footer">
    ...
    const data = await resend.emails.send({
      from: 'StayCool Website <onboarding@resend.dev>',
