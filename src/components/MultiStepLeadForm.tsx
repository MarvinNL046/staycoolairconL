    ...
    return (
        <div className="bg-white rounded-[2.5rem] p-8 sm:p-10 shadow-2xl relative overflow-hidden h-full flex flex-col justify-center">
            ...
            <div className="mb-8 text-center relative z-10">
                {/* Social Proof Badge */}
                <p className="text-sm text-gray-600 mb-6">Persoonlijk aircoadvies voor uw woning in Limburg</p>

                <h2 className="text-3xl font-black text-quatt-dark mb-2 tracking-tighter">
                        ...
                        >
                            ...
                            <div className="pt-4">
                                ...
                                <div className="flex items-center justify-center gap-4 mt-6">
                                    ...
                                    <p className="text-xs font-bold text-gray-600">Installatieadvies voor uw woning in Limburg</p>
                                </div>
                            </div>
                        </m.div>
                    ) : (
