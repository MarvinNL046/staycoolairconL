...
export const CITY_SERVICES_VARIANTS: Record<CityTier, string[]> = {
  ...
  middel: [
    ...
    `Wat u in {{city}} van ons kunt verwachten: vrijblijvende opname, een offerte met alle posten erop (geen "starting at"), installatie binnen 1-3 weken na akkoord, en daarna jaarlijks onderhoud op aanvraag. Voor airco-warmtepompen helpen we met de ISDE-subsidie-aanvraag en verrekenen die direct in de offerte waar mogelijk. Geen "u kunt het later claimen".`,
  ],
  klein: [
