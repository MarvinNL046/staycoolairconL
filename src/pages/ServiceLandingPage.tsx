...
import ClusterNextStep from '../components/ClusterNextStep';
...
export default function ServiceLandingPage({ slug }: ServiceLandingPageProps) {
  ...
  const isMaintenance = page.slug === 'airco-onderhoud-limburg';
  const ctaLabel = isMaintenance ? 'Bekijk onderhoudspakketten' : ctaLabels[page.ctaVariant];
  const primaryHref = isMaintenance ? '#onderhoud-aanbod' : '#contact';
  ...
  return (
    <>
      ...
      <main className="bg-white break-words">
          ...
          <div className="relative mx-auto max-w-7xl">
            ...
            <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
              <div>
                ...
                <h1 className="mb-6 max-w-4xl text-3xl font-black leading-tight text-quatt-dark sm:text-5xl lg:text-6xl">
                  {page.h1}
                </h1>
                ...
                <div className="flex flex-col gap-3 sm:flex-row">
                  ...
                  >
                    {isMaintenance ? 'Bekijk onderhoudspakketten' : 'Ontvang vrijblijvend een offerte'}
                    <ArrowRight className="ml-2 h-5 w-5" />
                  </a>
                  <a
                    href={isMaintenance ? '/onderhoud' : 'https://afspraken.staycoolairco.nl'}
                    target="_blank"
                  ...
                  >
                    {isMaintenance ? 'Onderhoud voor bestaande klanten' : 'Plan gratis adviesgesprek'}
                  </a>
                </div>
              </div>
              ...
              <aside className="rounded-[2rem] bg-white p-6 shadow-2xl shadow-quatt-dark/10 ring-1 ring-black/5">
                <div className="mb-6 rounded-3xl bg-quatt-dark p-6 text-white">
                  ...
                  <p className="text-white/80">
                    {isMaintenance ? 'Voor bestaande klanten met een airco die door StayCool is geleverd en geïnstalleerd.' : 'Beschrijf kort je woning en wens. Je ontvangt snel duidelijkheid over de best passende vervolgstap.'}
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <strong className="block text-quatt-dark">{isMaintenance ? 'Jaarlijks onderhoud' : 'Persoonlijk advies'}</strong>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <strong className="block text-quatt-dark">{isMaintenance ? 'Zelf uw pakket kiezen' : 'Vrijblijvende aanvraag'}</strong>
                      <span className="text-sm text-gray-600">{isMaintenance ? 'U bevestigt uw keuze op de aanmeldpagina.' : 'Je beslist zelf of je met het voorstel verder wilt.'}</span>
                    </div>
                  </div>
                  <div className="flex gap-3">
        ...
        <ClusterNextStep maintenance={page.category === 'maintenance'} />
        <section className="px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto grid grid-cols-1 max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr]">
            <div>
        ...
        <section className="bg-quatt-dark px-4 py-20 text-white sm:px-6 lg:px-8">
          <div className="mx-auto grid grid-cols-1 max-w-7xl gap-10 lg:grid-cols-[1fr_0.85fr] lg:items-center">
            <div>
            ...
            <div id="offerte" className="rounded-[2rem] bg-white p-6 text-quatt-dark shadow-2xl">
              <h2 className="mb-3 text-2xl font-black">{isMaintenance ? 'Bekijk onderhoudspakketten' : 'Ontvang vrijblijvend een offerte'}</h2>
              <p className="mb-5 text-gray-600">
                {isMaintenance ? 'Vergelijk de inhoud en prijs per complete unit en kies daarna uw pakket.' : 'Bespreek uw wensen en ontvang een voorstel met installatiekosten en planning.'}
              </p>
              <a
                href={primaryHref}
              ...
              >
                {isMaintenance ? 'Vergelijk Basis en Premium' : 'Start je aanvraag'}
                <ArrowRight className="ml-2 h-5 w-5" />
              </a>
            </div>
          </div>
          ...
          <div className="mx-auto grid grid-cols-1 max-w-7xl gap-12 lg:grid-cols-2">
            <div>
              ...
              <ol className="space-y-5">
                {(isMaintenance ? [
                  'Vergelijk Basis en Premium voor uw StayCool-installatie.',
                  'Bevestig uw pakket op de aanmeldpagina.',
                  'Vul uw klant- en installatiegegevens in en bekijk de totaalprijs.',
                  'Controleer de voorwaarden en rond uw aanmelding af.',
                ] : [
        ...
        <section className="bg-quatt-orange px-4 py-16 text-white sm:px-6 lg:px-8">
          <div className="mx-auto flex max-w-5xl flex-col items-center justify-between gap-6 text-center md:flex-row md:text-left">
            <div>
              <h2 className="mb-2 text-3xl font-black">{isMaintenance ? 'Jaarlijks onderhoud' : 'Persoonlijk advies'}</h2>
        ...
        {isMaintenance ? <div id="onderhoud-aanbod" className="mx-auto max-w-5xl px-4 scroll-mt-28"><MaintenanceOffer /></div> : <Contact />}
      </main>
    </>
  );
}
