...
const ToshibaVsTosotAirco = () => {
  const comparisonPoints = [
    {
      icon: ThermometerSun,
      title: "Prestaties",
      toshiba: {
        pros: ["Hoge SCOP/SEER waarden", "Geavanceerde inverter technologie"],
        cons: ["Premium prijsklasse"]
      },
      tosot: {
        pros: ["Goede basis prestaties", "Uitstekende prijs-prestatie"],
        cons: ["Iets lagere efficiëntiewaarden"]
      }
    },
    {
      icon: Wifi,
      ...
      toshiba: {
        pros: ["Home AC Control app", "Uitgebreide programmering"],
        cons: ["App soms minder intuïtief"]
      },
      tosot: {
        pros: ["Eenvoudige WiFi bediening", "Basis smart functies"],
        cons: ["Beperktere app mogelijkheden"]
      }
    },
    {
      icon: Volume2,
      title: "Geluidsniveau",
      toshiba: {
        pros: ["Zeer stil vanaf 19dB", "Geavanceerde stille modus"],
        cons: ["Duurdere modellen voor laagste geluid"]
      },
      tosot: {
        pros: ["Acceptabel geluidsniveau (22dB)", "Goede nachtmodus"],
        cons: ["Niet de stilste in de markt"]
      }
    },
    {
      icon: Wind,
      ...
      toshiba: {
        pros: ["3D luchtstroomregeling", "Magic Coil coating"],
        cons: ["Premium features alleen op duurdere modellen"]
      },
      tosot: {
        pros: ["Effectieve luchtverdeling", "Anti-bacteriële coating"],
        cons: ["Basis luchtstroomopties"]
      }
    }
  ];
  ...
  const popularModels = [
    {
      ...
      models: [
        {
          name: "Seiya",
          features: ["Basis model", "Energiezuinig", "WiFi optioneel"],
          price: "€1.100 - €1.600"
        },
        {
          name: "Shorai Edge",
          features: ["Design model", "Plasma filter", "WiFi ingebouwd"],
          price: "€1.500 - €2.000"
        },
        {
          name: "Haori",
          features: ["Premium design", "Verwisselbare covers", "Ultra stil"],
          price: "€2.000 - €2.800"
        }
      ]
    },
    {
      ...
      models: [
        {
          name: "Pular",
          features: ["Instapmodel", "Basis functies", "Betrouwbaar"],
          price: "€800 - €1.200"
        },
        {
          name: "Clivia",
          features: ["Middenklasse", "WiFi Ready", "I-Feel functie"],
          price: "€1.000 - €1.500"
        },
        {
          name: "Cosmo",
          features: ["Topmodel", "Ultra DC Inverter", "Premium design"],
          price: "€1.300 - €1.800"
        }
      ]
    }
  ...
  return (
    <ArticleLayout
      ...
      tags={['Vergelijking', 'Toshiba', 'Tosot', 'Advies']}
    >
      <section className="prose prose-lg max-w-none">
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="m-0 text-blue-800">
                Toshiba staat bekend om hoogwaardige technologie en innovatie, terwijl Tosot 
                zich onderscheidt met een sterke prijs-kwaliteitverhouding. Lees verder voor 
        ...
        <p>
          Toshiba en Tosot zijn beide gerespecteerde namen in de airco markt, maar met 
          verschillende positionering. Toshiba is een gevestigd Japans merk met een lange 
          historie, terwijl Tosot als onderdeel van Gree een sterke nieuwkomer is met 
          ...
          {comparisonPoints.map((point) => (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-semibold text-blue-900 mb-3">Toshiba</h4>
                  <div className="space-y-4">
                    <div>
                      <h5 className="text-green-700 text-sm font-medium mb-2">Voordelen</h5>
                      <ul className="space-y-1 m-0">
                        {point.toshiba.pros.map((pro, index) => (
                    ...
                    <div>
                      ...
                      <ul className="space-y-1 m-0">
                        {point.toshiba.cons.map((con, index) => (
                          <li key={index} className="flex items-start">
                ...
                <div>
                  <h4 className="font-semibold text-blue-900 mb-3">Tosot</h4>
                  <div className="space-y-4">
                    <div>
                      <h5 className="text-green-700 text-sm font-medium mb-2">Voordelen</h5>
                      <ul className="space-y-1 m-0">
                        {point.tosot.pros.map((pro, index) => (
                          <li key={index} className="flex items-start">
                            <CheckCircle className="h-5 w-5 text-green-500 mr-2 flex-shrink-0 mt-1" />
                            {pro}
                          </li>
                    ...
                    <div>
                      <h5 className="text-red-700 text-sm font-medium mb-2">Nadelen</h5>
                      <ul className="space-y-1 m-0">
                        {point.tosot.cons.map((con, index) => (
                          <li key={index} className="flex items-start">
                            <AlertTriangle className="h-5 w-5 text-red-500 mr-2 flex-shrink-0 mt-1" />
                            {con}
                          </li>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="m-0 text-yellow-800">
                Let op de garantievoorwaarden en het servicenetwerk in jouw regio. 
                Bekijk onze <Link to="/kennisbank/wat-kost-een-airco-plaatsen" className="text-yellow-800 underline">prijzengids</Link> voor 
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 my-8 border-l-4 border-blue-500">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-medium mb-2">Toshiba</h4>
            ...
            <div>
              <h4 className="font-medium mb-2">Tosot</h4>
              <ul className="space-y-2 m-0">
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 flex-shrink-0 mt-1" />
                  Groeiend servicenetwerk
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 flex-shrink-0 mt-1" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
          <div className="bg-blue-50 rounded-lg p-6">
            <h3 className="text-blue-900 mt-0">Toshiba</h3>
            <ul className="mb-0">
              <li>Instapmodellen vanaf €1.100</li>
              <li>Middenklasse €1.500 - €2.000</li>
              <li>Premium modellen €2.000+</li>
            </ul>
          </div>
          <div className="bg-blue-50 rounded-lg p-6">
            <h3 className="text-blue-900 mt-0">Tosot</h3>
            <ul className="mb-0">
              <li>Instapmodellen vanaf €800</li>
              <li>Middenklasse €1.000 - €1.500</li>
              <li>Premium modellen €1.300+</li>
            </ul>
          </div>
        </div>
        ...
        <p>
          <strong>Kies voor Toshiba als:</strong>
        </p>
        <ul>
          <li>Je premium kwaliteit en innovatie zoekt</li>
          <li>Lange garantie belangrijk is</li>
          <li>Je geavanceerde features wilt</li>
        </ul>

        <p>
          <strong>Kies voor Tosot als:</strong>
        </p>
        <ul>
          <li>Je een scherpe prijs zoekt</li>
          <li>Basis functies voldoende zijn</li>
...
export default ToshibaVsTosotAirco;
