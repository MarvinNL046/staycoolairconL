...
export default function AircoBrunssum() {
  const breadcrumbItems = [
    { label: 'Kennisbank', path: '/kennisbank' },
    { label: 'Airco Brunssum', path: '/kennisbank/airco-brunssum' }
  ];

  return (
    <>
      <Helmet>
        <title>Airco Brunssum | Expert Airconditioning Service & Installatie</title>
        <meta 
          name="description" 
          content="Op zoek naar een betrouwbare airco specialist in Brunssum? Wij bieden professionele airconditioning services, van installatie tot onderhoud. Erkend en gecertificeerd."
        />
        <meta 
          name="keywords" 
          content="airco brunssum, airconditioning brunssum, airco installatie brunssum, airco onderhoud brunssum, klimaatbeheersing brunssum"
        />
        <link rel="canonical" href="https://staycoolairco.nl/kennisbank/airco-brunssum" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl font-bold text-gray-900 mb-8">
              Airco Brunssum: Uw Specialist in Klimaatcomfort
            </h1>

            <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
              <h2 className="text-2xl font-semibold mb-4">Airconditioning in Brunssum</h2>
              <p>
                ...
                zijn we uw lokale expert in Brunssum. Met jarenlange ervaring in het installeren en 
            ...
            <div className="bg-blue-50 rounded-xl p-8 mb-8">
              <h2 className="text-2xl font-semibold mb-4">Werkgebied Brunssum</h2>
              <p className="mb-4">
                We zijn actief in heel Brunssum en omgeving, waaronder:
              </p>
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  <h3 className="font-semibold mb-2">Brunssum</h3>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
              <h2 className="text-2xl font-semibold mb-4">Waarom Kiezen voor Onze Service in Brunssum?</h2>
              <div className="space-y-4">
                <div>
                  ...
                  <p>
                    ...
                    we Brunssum als geen ander. We begrijpen de uitdagingen van klimaatbeheersing in 
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
              <h2 className="text-2xl font-semibold mb-4">Projecten in Brunssum</h2>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
              <h2 className="text-2xl font-semibold mb-4">Contact in Brunssum</h2>
              <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow-lg p-8 text-white">
              <h2 className="text-2xl font-semibold mb-4">Airco Nodig in Brunssum?</h2>
              <p className="mb-6">
                Ontdek waarom steeds meer inwoners van Brunssum voor onze service kiezen. 
