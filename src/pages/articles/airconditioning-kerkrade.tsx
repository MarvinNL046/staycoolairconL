...
export default function AirconditioningKerkrade() {
  const breadcrumbItems = [
    { label: 'Kennisbank', path: '/kennisbank' },
    { label: 'Airconditioning Kerkrade', path: '/kennisbank/airconditioning-kerkrade' }
  ];

  return (
    <>
      <Helmet>
        <title>Airconditioning Kerkrade | Expert Airco Service & Installatie</title>
        <meta 
          name="description" 
          content="Op zoek naar een betrouwbare airconditioning specialist in Kerkrade? Wij bieden professionele airco services, van installatie tot onderhoud. Erkend en gecertificeerd."
        />
        <meta 
          name="keywords" 
          content="airconditioning kerkrade, airco kerkrade, airco installatie kerkrade, airco onderhoud kerkrade, klimaatbeheersing kerkrade"
        />
        <link rel="canonical" href="https://staycoolairco.nl/kennisbank/airconditioning-kerkrade" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl font-bold text-gray-900 mb-8">
              Airconditioning Kerkrade: Uw Specialist in Klimaatcomfort
            </h1>

            <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
              <h2 className="text-2xl font-semibold mb-4">Airconditioning in Kerkrade</h2>
              <p>
                ...
                zijn we uw lokale expert in Kerkrade. Met jarenlange ervaring in het installeren en 
            ...
            <div className="bg-blue-50 rounded-xl p-8 mb-8">
              <h2 className="text-2xl font-semibold mb-4">Werkgebied Kerkrade</h2>
              <p className="mb-4">
                We zijn actief in heel Kerkrade en omgeving, waaronder:
              </p>
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  <h3 className="font-semibold mb-2">Kerkrade</h3>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
              <h2 className="text-2xl font-semibold mb-4">Waarom Kiezen voor Onze Service in Kerkrade?</h2>
              <div className="space-y-4">
                <div>
                  ...
                  <p>
                    ...
                    we Kerkrade als geen ander. We begrijpen de uitdagingen van klimaatbeheersing in 
                    verschillende type gebouwen, van karakteristieke mijnwerkerswoningen tot moderne nieuwbouw.
                  </p>
                </div>
                <div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
              <h2 className="text-2xl font-semibold mb-4">Projecten in Kerkrade</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="font-semibold mb-2">Particulier</h3>
                  <ul className="space-y-2">
                    <li>• Woningen en appartementen</li>
                    <li>• Mijnwerkerswoningen</li>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
              <h2 className="text-2xl font-semibold mb-4">Contact in Kerkrade</h2>
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="flex items-center text-gray-600">
                  ...
                  <span>Kerkrade en omgeving</span>
                </div>
              </div>
            </div>

            <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow-lg p-8 text-white">
              <h2 className="text-2xl font-semibold mb-4">Airco Nodig in Kerkrade?</h2>
              <p className="mb-6">
                Ontdek waarom steeds meer inwoners van Kerkrade voor onze service kiezen. 
