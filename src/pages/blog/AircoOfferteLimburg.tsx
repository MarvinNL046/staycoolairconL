            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="not-prose bg-orange-50 rounded-lg p-6 my-8">
                ...
                <p className="text-gray-700 mb-4">
                  Wil je exact weten wat een airco kost in jouw situatie? Plan een vrijblijvend adviesgesprek met één van onze specialisten. Nu bij aanschaf van een complete airco installatie: gratis onderhoudsbeurt t.w.v. €189,-!
                </p>
                <Link 
                  to="/contact" 
