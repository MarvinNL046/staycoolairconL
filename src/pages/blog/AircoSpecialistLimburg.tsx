            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="not-prose bg-orange-50 rounded-lg p-6 my-8">
                ...
                <p className="text-gray-700 mb-4">
                  Profiteer nu van onze actie: gratis onderhoudsbeurt t.w.v. €189,- bij aanschaf van een complete airco installatie. Geldig in heel Limburg en bij installatie voor 1 juli 2025.
                </p>
                <Link 
                  to="/contact" 
