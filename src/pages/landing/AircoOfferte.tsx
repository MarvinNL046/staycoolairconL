...
import { Phone,CheckCircle,Clock,Shield,Wrench,ChevronDown,ArrowRight , Mail} from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-base md:text-lg text-gray-600">
                Vul het formulier hieronder in of bel ons direct op 046 202 1430. U kunt ook mailen naar info@staycoolairco.nl.
              </p>
            </div>
            <div className="text-center">
            ...
            <div className="bg-sky-50 rounded-2xl p-8 border border-sky-100">
              ...
              <div className="space-y-4">
                ...
                <a
                  ...
                  className="flex items-center gap-3 bg-white rounded-xl p-4 border border-sky-200 hover:bg-sky-50 transition-colors font-semibold text-gray-800"
                >
                  <Mail className="h-6 w-6 shrink-0 text-sky-600" aria-hidden="true" />
