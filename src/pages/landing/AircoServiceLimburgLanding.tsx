...
const AircoServiceLimburgLanding: React.FC = () => {
  ...
  const serviceTypes = {
    ...
    reparatie: {
      ...
      price: '€149 eerste uur (incl. voorrijkosten), daarna €28,75 per kwartier',
      features: [
  ...
  const pricingTable = [
    ...
    },
    {
      ...
      residential: '€149 eerste uur, daarna €28,75/kwartier',
      commercial: '€95/uur excl. btw + reistijd',
  ...
  const faqItems = [
    {
      ...
      answer: 'Een eenmalige onderhoudsbeurt kost €189. Voordeliger zijn onze onderhoudscontracten: Basis pakket €13/maand (€156/jaar) of Premium pakket €16/maand (€192/jaar). Met een contract bespaart u €33 op onderhoud en heeft u geen voorrijkosten bij storing. Storing verhelpen zonder contract: €149 voor het eerste uur (incl. voorrijkosten en diagnose), daarna €28,75 per kwartier.'
    },
    {
