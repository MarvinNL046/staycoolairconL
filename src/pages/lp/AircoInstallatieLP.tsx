...
/**
 * Naked leadgen landing page voor betaald (Meta) verkeer.
 * - Geen navbar/footer/chat/popups: layout-chrome wordt in App.tsx uitgezet
 *   voor alle routes onder de `/lp/`-prefix.
 * - noIndex: paid LP mag niet organisch concurreren met de echte
 *   airco-installatie-pagina's (anti-cannibalisatie).
 * - Eén conversiedoel: offerte-formulier + bel-knop. Bewust GEEN uitgaande
 *   links (extra-click leak kost conversie op paid traffic).
 */
...
export default function AircoInstallatieLP() {
  return (
    <div className="min-h-screen bg-white text-quatt-dark">
      <MetaTags
        title="Airco laten installeren in Limburg | Gratis offerte | StayCool"
        description="Airco laten installeren in Limburg? Gecertificeerde monteurs, vaak binnen enkele dagen geïnstalleerd, tot 5 jaar garantie. Vraag direct een vrijblijvende offerte aan."
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 py-10 lg:grid-cols-2 lg:py-16">
          ...
          <div className="text-white">
            <h1 className="text-3xl font-bold leading-tight sm:text-4xl lg:text-5xl">
              Airco laten installeren in Limburg
            </h1>
            <p className="mt-4 max-w-xl text-lg text-white/90">
              Gecertificeerde monteurs, een strakke installatie en vaak binnen
              enkele dagen geregeld. Koel in de zomer, warm in de winter.
            </p>
