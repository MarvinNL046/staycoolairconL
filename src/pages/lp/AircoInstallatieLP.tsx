...
const variantA: LPVariant = {
  ...
  metaDescription:
    "Airco laten installeren in Limburg? Gecertificeerde monteurs, vaak binnen enkele dagen geïnstalleerd, garantie volgens offerte. Vraag direct een vrijblijvende offerte aan.",
