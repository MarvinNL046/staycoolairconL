...
import { CheckCircle,Shield,Euro,Phone,Mail,Calculator,TrendingUp,Star,Award } from 'lucide-react';
...
const AircoInstallatieMaastricht = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Airco biedt Maastrichtse bewoners comfort het hele jaar door: koeling tijdens warme zomers, efficiënte verwarming in de winter, en luchtfiltering voor betere luchtkwaliteit. Met situatieafhankelijke besparing ten opzichte van traditionele verwarming en het vermijden van dure terugleververgoedingen bij zonnepanelen, is airco een slimme investering voor Maastrichtse huishoudens. Bovendien verhoogt het de waarde van uw woning aanzienlijk."
    }
  ];
  ...
  return (
    <>
      <MetaTags
        ...
        description="Airco installatie Maastricht ✓ F-gassen gecertificeerd ✓ situatieafhankelijke besparing ✓ garantie volgens offerte ✓ Centrum, Wyck ✓ Gratis offerte!"
      />
      ...
      <SchemaMarkup
        ...
        data={{
          ...
          "description": "Professionele airco installatie en onderhoud in Maastricht en omgeving. F-gassen gecertificeerd met garantie volgens offerte op premium A-merken.",
          "provider": {
            "@type": "LocalBusiness",
            "name": "StayCool Airco",
        ...
        <section className="bg-gradient-to-br from-sky-400 to-sky-500 text-white">
          <div className="container mx-auto px-4 py-16">
            ...
            <p className="text-xl md:text-2xl text-sky-50 mb-8 max-w-3xl">
              ...
              Professionele klimaatbeheersing voor de hoofdstad van Limburg. F-gassen gecertificeerde installatie met situatieafhankelijke besparing en garantie volgens offerte op premium A-merken.
            </p>
        ...
        <section className="py-16 bg-gradient-to-br from-sky-400 to-sky-500 text-white">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 text-sky-50">
              Bel of mail ons voor direct advies over airco installatie in Maastricht
            </p>
